...
public class TestUtility {
    ...
    static final Map<Character, int[]> coord;
    static
    {
        coord = new HashMap<>();
        coord.put('A', new int[]{0, 0}); coord.put('M', new int[]{2, 0});
        coord.put('B', new int[]{0, 2}); coord.put('N', new int[]{2, 2});
        coord.put('C', new int[]{0, 4}); coord.put('O', new int[]{2, 4});
        coord.put('D', new int[]{0, 6}); coord.put('P', new int[]{2, 6});
        coord.put('E', new int[]{0, 8}); coord.put('Q', new int[]{2, 8});
        coord.put('F', new int[]{0, 10}); coord.put('R', new int[]{2, 10});
        coord.put('G', new int[]{1, 1}); coord.put('S', new int[]{3, 1});
        coord.put('H', new int[]{1, 3}); coord.put('T', new int[]{3, 3});
        coord.put('I', new int[]{1, 5}); coord.put('U', new int[]{3, 5});
        coord.put('J', new int[]{1, 7}); coord.put('V', new int[]{3, 7});
        coord.put('K', new int[]{1, 9}); coord.put('W', new int[]{3, 9});
        coord.put('L', new int[]{1, 11}); coord.put('X', new int[]{3, 11});
    }
}
